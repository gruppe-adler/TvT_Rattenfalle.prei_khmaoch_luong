...
// ACE Nightvision
force ace_nightvision_aimDownSightsBlur = 0.311624;
ace_nightvision_disableNVGsWithSights = false;
force ace_nightvision_effectScaling = 0.521709;
...
force ace_viewdistance_viewDistanceLandVehicle = 2;
force ace_viewdistance_viewDistanceOnFoot = 2;
