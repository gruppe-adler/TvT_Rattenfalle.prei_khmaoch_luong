...
private _positionEmpty = nearestObjects [_vehPos, ["LandVehicle", "Air"], (sizeOf _vehType)/2]; // (_vehPos findEmptyPosition [0,0,_vehType]);
...
if (_isRoom) then {
    ...
    [_vehType, _vehPos, _vehDir] call GRAD_simpleWaveRespawn_fnc_simpleVehicleRespawnSpawn;
};
