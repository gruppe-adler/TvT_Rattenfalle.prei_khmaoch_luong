...
{
	_x set [2, 15 - random 5];
} forEach [_wp0, _wp1, _wp2, _wp3, _wp4, _wp5, _wp6, _wp7];

private _circlePoint = [_wp0, _wp1, _wp2, _wp3, _wp4, _wp5, _wp6, _wp7];

missionNamespace setVariable [format ["GRAD_crows_circlePointArray_%1", _index], _circlePoint];
